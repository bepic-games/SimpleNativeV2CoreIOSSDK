...
@property (nonatomic,strong) NSString * toponRewardMap;
@property (nonatomic,strong) NSString * toponInterstitial;
@property (nonatomic,strong) NSString * toponInterstitialMap;
...
- (bool) hasReward:(NSString *) adEntry;
- (void) showReward:(NSString *) adEntry;
- (bool) hasInterstitial:(NSString *) adEntry;
